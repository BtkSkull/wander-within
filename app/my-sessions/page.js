    ...
    return (
        <main style={{ minHeight: "100vh", background: "#eee4ff", padding: "clamp(20px, 5vw, 40px) clamp(12px, 4vw, 20px)" }}>
            <div style={{ maxWidth: "700px", margin: "0 auto", width: "100%" }}>
                <h1 style={{ color: "#463280", textAlign: "center", marginBottom: "10px", fontSize: "clamp(24px, 5vw, 32px)" }}>
                    My Sessions
                </h1>
                ...
                <a
                    ...
                    style={{
                        ...
                        marginBottom: "24px", color: "#25D366", fontWeight: 600, textDecoration: "none",
                        boxShadow: "0 2px 8px rgba(0,0,0,0.06)", fontSize: "clamp(13px, 3vw, 15px)", textAlign: "center",
                    }}
                >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    {bookings.map((booking) => (
                        <div key={booking.id} style={{ background: "white", borderRadius: "16px", padding: "clamp(16px, 4vw, 20px)" }}>
                            <h3 style={{ color: "#463280", margin: "0 0 8px", fontSize: "clamp(16px, 4vw, 18px)" }}>{booking.service}</h3>
                            <p style={{ margin: "0 0 4px", color: "#5f4370", fontSize: "clamp(13px, 3vw, 15px)" }}>
