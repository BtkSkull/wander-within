        ...
        <div className={styles.card}>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
                ...
                <div className={styles.row}>
                    <input name="firstName" placeholder="Full Name" value={form.firstName} onChange={handleChange} required />
                ...
                <div style={{ margin: "10px 0" }}>
                    <p style={{ fontSize: "14px", color: "#463280", fontWeight: 600, marginBottom: "8px" }}>Gender</p>
                    <div style={{ display: "flex", gap: "18px", flexWrap: "wrap", fontSize: "14px" }}>
                    ...
                    {form.gender === "Other" && (
                        <input
                            ...
                            onChange={handleChange}
                            style={{ marginTop: "10px", width: "100%", padding: "12px", border: "1px solid #bda6d8", borderRadius: "10px", background: "#f4edff" }}
                        />
                    )}
                </div>
                ...
                <div className={styles.row}>
                    ...
                    <input name="phone" placeholder="Phone Number (+91XXXXXXXXXX)" value={form.phone} onChange={handleChange} required />
                </div>
                <div className={styles.row}>
                    <input name="occupation" placeholder="Occupation (optional)" value={form.occupation} onChange={handleChange} />
                    <input name="cityCountry" placeholder="City / Country" value={form.cityCountry} onChange={handleChange} />
                </div>

                <h3>Emergency Contact</h3>
                <div className={styles.row}>
                    <input name="emergencyContact" placeholder="Full Name" value={form.emergencyContact} onChange={handleChange} />
                    <input name="emergencyContactRelationship" placeholder="Relationship (e.g. Parent, Partner)" value={form.emergencyContactRelationship} onChange={handleChange} />
                </div>
                <div className={styles.row}>
                    <input name="emergencyContactPhone" placeholder="Emergency Contact Phone" value={form.emergencyContactPhone} onChange={handleChange} />
                </div>
